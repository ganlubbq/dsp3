function theta = estimateCarrierPhaseDDML(observations, blocksize, mn)
% Implementing the carrier phase estimation based on the decision-directed
% maximum likelihood criterial. The algorithm works blockwise, within each
% block the phase is assumed to be deterministic and constant.
%
